...
class Bird extends Entity {
    ...
    loadAnimations() {
        ...
        //idel
        //facing right
        this.animator[0][0] = new Animator(ASSET_MANAGER.getAsset("images/pixalBird.png"), 2, 0, 50, 100, 2, 0.3);

        // idel
        // facing Left
        this.animator[0][1] = new Animator(ASSET_MANAGER.getAsset("images/pixalBirdFlipped.png"), 626, 0, -65, 100, 2, 0.2);

        // //walk
        // //facing right
        this.animator[1][0] = new Animator(ASSET_MANAGER.getAsset("images/pixalBird.png"), 2, 0, 50, 100, 2, 0.2);

        // //walk 
        // //facing left
        this.animator[1][1] = new Animator(ASSET_MANAGER.getAsset("images/pixalBirdFlipped.png"), 626, 0, -68, 100, 2, 0.2);
